...
export default function Loading() {
  return (
    <ThreeColumnLayout
      profileColumn={<ProfileSkeleton />}
      projectsColumn={<ProjectsSkeleton />}
      blogColumn={<BlogSkeleton />}
    />
  );
}
...
function ProfileSkeleton() {
  return (
    <div className="p-4 md:p-8 space-y-6">
      <div className="h-10 md:h-14 w-2/3 bg-gray-200 dark:bg-gray-800 rounded" />
