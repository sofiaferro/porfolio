  ...
  return (
    <header className="border-b border-[var(--hairline)]">
      <div className="mx-auto flex max-w-3xl flex-wrap items-baseline justify-between gap-x-4 gap-y-1 px-4 py-4 sm:px-6">
        ...
        >
          <Link href="/projects" className="-my-1 py-1 text-[var(--muted)] hover:text-[var(--accent)]">
            ./{t("projects")}
          </Link>
          <Link href="/manifiesto" className="-my-1 py-1 text-[var(--muted)] hover:text-[var(--accent)]">
            ./{t("manifiesto")}
          </Link>
          <Link href="/about" className="-my-1 py-1 text-[var(--muted)] hover:text-[var(--accent)]">
            ./{t("about")}
          </Link>
          <LocaleSwitcher />
          <ThemeToggle />
